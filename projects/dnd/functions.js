...
function addListener(eventName, target, fn) {
  target.addEventListner(eventName, fn);
}
...
function removeListener(eventName, target, fn) {
  target.removeEventListner(eventName, fn);
}
...
function skipDefault(eventName, target) {
  target.addEventListner(eventName, (e) => {
    e.preventDefault();
  })
}
...
function emulateClick(target) {
  target.dispatchEvent(new MauseEvent('click'));
}
...
function delegate(target, fn) {
  target.addEventListner('click', (e) => {
